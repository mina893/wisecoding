...
보내주신 와이즈코딩 인스타그램 주소가 연결되어 있습니다.
블로그·유튜브 메뉴는 제거되었습니다.

주소를 변경하려면 link-settings.html을 열고 새 주소를 입력한 뒤 설정 파일을 다운로드하세요.
다운로드한 channels.js를 GitHub의 index.html과 같은 폴더에 덮어 올리면 반영됩니다.

## 공식 로고
상단과 하단의 공식 로고 아래에 울산 옥동점학원 문구를 적용했습니다. wisecoding-logo.png도 반드시 함께 업로드하세요.
